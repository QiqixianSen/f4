...
export const getBooks = id => {
  ...
  return dispatch => {
    axios
      .get(
        `http://read.xiaoshuo1-sm.com/novel/i.php?do=sp_get&authorId=${authorId}&bookId=${bookId}&fetch=merge&sqUid=8000000&source=store&size=3&page=1&shuqi_h5=&_=1563894925079`
      )
      .then(res => {

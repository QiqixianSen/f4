...
export const getboylist = () => {
  return (dispatch) => {
    axios.get("http://bookstoreapi.shuqireader.com/eva_bookstore/v1/stencil/query?appId=1&pageId=2&channelId=&versionId=&ver=&shuqi_h5=&md5key=&userId=8000000&timestamp=1563988545&type=2&resetcache=&sign=92A0F43C78F112E5A2A3374FD0171B59&key=shuqiapi&_=1563988545512").then(res => {
      const hotlist = res.data.data.module[6].content.data.map(({ content, m_s_name }) => ({
        content,
        m_s_name
      }));
      console.log(hotlist)
